        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="wd-30 ht-30 rounded-circle img-thumbnail" src="{{ auth()->user()->photo }}"
                        alt="profile">
                </a>
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        ...
                        <div class="text-center">
                            <p class="tx-16 fw-bolder">{{ Str::title(auth()->user()->full_name) }}</p>
                            <p class="tx-12 text-muted">{{ Str::lower(auth()->user()->email) }}</p>
                        </div>
                    </div>
                    <ul class="list-unstyled p-1">
                        ...
                        <li class="dropdown-item py-2">
                            <a href="{{ route('admin.profile') }}#form" class="text-body ms-0">
                        ...
                        <li class="dropdown-item py-2">
                            ...
                            <form action="{{ route('admin.logout') }}" method="POST" >
                                @csrf
                                <button type="submit" class="text-body ms-0 btn" style="background: rgb(216, 5, 40);color:white">
                                <i class="me-2 icon-md text-white"  data-feather="log-out"></i>
                                    logout</button>
                            </form>
                        </li>
                    </ul>
